    ...
    <main className="min-h-screen flex flex-col md:flex-row"
      ...
      <section ref={panelRef}
        ...
        <div className="relative z-10 flex-grow flex flex-col items-center justify-center text-center login-fade">
          ...
          <h1 className="font-bold mb-1 text-4xl md:text-5xl lg:text-6xl"
              style={{fontFamily:FONT_DISPLAY,letterSpacing:'-0.02em',color:'var(--color-gold-light)'}}>
            WIS-CMS
          </h1>
          <p className="italic text-xl md:text-2xl"
             style={{fontFamily:FONT_DISPLAY,color:'rgba(255,255,255,0.8)'}}>
      ...
      <section className="md:w-1/2 flex items-center justify-center"
        ...
        <div className="w-full login-fade2" style={{maxWidth:'440px'}}>
          ...
          {error && (
            <div role="alert" className="flex items-center gap-2 rounded-lg mb-6"
