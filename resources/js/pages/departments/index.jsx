...
export default function DepartmentsPage() {
  ...
  const statCards = [
    { label:'Total Departments', value: total,    icon: ICONS.tree,     barPct: 100,       barColor:NAVY },
    ...
    <div className="space-y-6" style={{maxWidth:'1440px'}}>
      ...
      {loading ? (
        ...
        <div className="text-center py-16" style={{...cardBase, padding:'40px'}}>
          ...
          <h3 className="font-bold text-lg mb-2" style={{fontFamily:FONT_DISPLAY,color:NAVY}}>No departments yet</h3>
            ...
            <div key={dept.id} className="flex flex-col transition-all hover:-translate-y-1"
              ...
              <div className="flex items-center justify-between mt-6 pt-6" style={{borderTop:BORDER}}>
                <div className="flex items-center gap-1.5" style={{color:MUTED}}>
                  ...
                  <span style={{fontSize:'14px'}}><span className="font-semibold" style={{color:NAVY}}>{dept.members_count}</span> Members</span>
                </div>
